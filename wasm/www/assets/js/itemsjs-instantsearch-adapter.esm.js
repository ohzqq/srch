...
var _ = __nccwpck_require__(439);

var helpers = __nccwpck_require__(413);

var FastBitSet = __nccwpck_require__(801);
/**
...
var lunr = __nccwpck_require__(974);
/**
...
var booleanParser = __nccwpck_require__(508);
...
var service = __nccwpck_require__(445);

var helpers = __nccwpck_require__(413);

var Fulltext = __nccwpck_require__(646);

var Facets = __nccwpck_require__(953);
...
/* harmony export */   "Eu": () => (/* binding */ createIndex),
/* harmony export */   "ii": () => (/* binding */ performSearch),
/* harmony export */   "m_": () => (/* binding */ getSearchClient)
/* harmony export */ });
/* harmony import */ var itemsjs__WEBPACK_IMPORTED_MODULE_0__ = __nccwpck_require__(739);
// src/adapter.ts


// src/adaptResponse.ts
function adaptResponse(response, query, processingTimeMS) {
...
// src/adapter.ts
var index;
function getSearchClient(newIndex) {
  return {
    search: (queries) => performSearch(queries, index || newIndex),
...
function createIndex(data, options) {
  index = itemsjs__WEBPACK_IMPORTED_MODULE_0__(data, options);
  return index;
}
function performSearch(requests, index2) {
  if (index2) {
...
var __webpack_exports__createIndex = __webpack_exports__.Eu;
var __webpack_exports__getSearchClient = __webpack_exports__.m_;
var __webpack_exports__performSearch = __webpack_exports__.ii;
export { __webpack_exports__createIndex as createIndex, __webpack_exports__getSearchClient as getSearchClient, __webpack_exports__performSearch as performSearch };
