...
__nccwpck_require__.d(__webpack_exports__, {
  ...
  "getSearchClient": () => (/* binding */ getSearchClient),
  "performSearch": () => (/* binding */ performSearch)
});

// EXTERNAL MODULE: ./node_modules/itemsjs/lib/index.js
var lib = __nccwpck_require__(739);
var lib_default = /*#__PURE__*/__nccwpck_require__.n(lib);
;// CONCATENATED MODULE: ./src/adaptResponse.ts
...
function adaptHit(item) {
    return Object.assign(Object.assign({ objectID: item.id }, item), { _highlightResult: {} });
}
...
;// CONCATENATED MODULE: ./src/adaptRequest.ts
...
;// CONCATENATED MODULE: ./src/adapter.ts
...
function createIndex(data, options) {
    index = lib_default()(data, options);
    return index;
}
function performSearch(requests, index) {
    if (index) {
